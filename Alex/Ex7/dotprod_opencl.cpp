    ...
    int main()
{
    std::vector<int> vec_Ns{10, 100, 1000, 10000, 30000, 60000, 100000, 300000, 600000, 1000000, 3000000, 6000000, 10000000};
    ...
    std::string header = "N;CPU_time;opencl_time;factor_opencl_CPU;GPU_time;factor_opencl_GPU";
        // to csv file
    ...
    */
    ...
    //
    std::string sep = ";";
    csv_times << N << sep << CPU_time << sep << opencl_time << sep << CPU_time/opencl_time << sep << GPU_time << sep << CPU_time/GPU_time << std::endl;
/*
    int M = 100;
